...
export const CHARACTER_SHADOW_COLOR = 'rgba(0, 0, 0, 0.2)';
export const BUBBLE_FADE_DURATION_SEC = 0.5;

/** Duration of READING state (agent at bookshelf doing RAG lookup) */
export const READ_INTERACTION_DURATION_SEC = 4.0;
/** Duration of THINKING state (agent at whiteboard doing chain-of-thought) */
export const THINK_INTERACTION_DURATION_SEC = 5.0;
/** Duration of DISCARDING state (agent at bin trimming context) */
...
export const SAVE_LAYOUT_ENDPOINT = `${API_BASE_URL}/save-layout`;
export const AGENT_QUERY_ENDPOINT = `${API_BASE_URL}/agent/query`;
export const LOCAL_STORAGE_KEY = 'archive-room-config';

// ── UI Theme (CSS Variables sync) ───────────────────────────
export const THEME_BG_COLOR = '#f5f0e8';
export const THEME_TEXT_COLOR = '#4a3728';
export const THEME_ACCENT_COLOR = '#d97706';
