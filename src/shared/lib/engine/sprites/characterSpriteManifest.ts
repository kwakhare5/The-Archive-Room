...
import { PALETTE_COUNT } from '@/shared/constants/config';
import { adjustSprite } from '@/shared/lib/engine/colorize';
import type { Direction, SpriteData } from '@/shared/types/types';
import { Direction as Dir } from '@/shared/types/types';
