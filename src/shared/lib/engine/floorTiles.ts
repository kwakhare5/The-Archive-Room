...
import { CANVAS_ERROR_TILE_COLOR, FALLBACK_FLOOR_COLOR, TILE_SIZE } from '@/shared/constants/config';
import { clearColorizeCache, getColorizedSprite } from './colorize';
import type { SpriteData } from '@/shared/types/types';
...
export { WALL_COLOR } from '@/shared/constants/config';
