...
import { DEFAULT_FLOOR_COLOR, DEFAULT_WALL_COLOR, UNDO_STACK_MAX_SIZE } from '@/shared/constants/config';
import type { ArchiveLayout, TileType as TileTypeVal } from '@/shared/types/types';
