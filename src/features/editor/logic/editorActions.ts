...
import { DEFAULT_NEUTRAL_COLOR } from '@/shared/constants/config';
import { getCatalogEntry, getRotatedType, getToggledType } from '@/features/spatial/logic/furnitureCatalog';
import { getPlacementBlockedTiles } from '@/features/spatial/logic/nexusSerializer';
import type { ArchiveLayout, PlacedFurniture, TileType as TileTypeVal } from '@/shared/types/types';
import { MAX_COLS, MAX_ROWS, TileType } from '@/shared/types/types';
