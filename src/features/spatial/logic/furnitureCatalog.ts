import type { FurnitureCatalogEntry, SpriteData } from '@/shared/types/types';
...
/** Returns true if the dynamic catalog has been successfully built from loaded assets. */
export function isCatalogReady(): boolean {
  return dynamicCatalog !== null;
}
