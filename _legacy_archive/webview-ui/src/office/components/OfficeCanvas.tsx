...
import { hasFloorSprites } from '../floorTiles.js';
import { getCatalogEntry, isCatalogReady, isRotatable } from '../layout/furnitureCatalog.js';
import { EditTool, TILE_SIZE } from '../types.js';
import { hasWallSprites } from '../wallTiles.js';
